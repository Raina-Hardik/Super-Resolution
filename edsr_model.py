...
class ConvBlock(nn.Module):
    def __init__(self, 
        ...
        self.act = (nn.LeakyReLU(negative_slope = 0.2, 
                                 inplace=True) if discriminator else nn.PReLU(num_parameters = out_channels))
...
class Generator(nn.Module):
    def __init__(self, 
        ...
        super().__init__()
        self.initial = ConvBlock(in_channels = in_channels, 
        ...
        self.convblock = ConvBlock(in_channels = num_channels, 
                                   out_channels =num_channels, 
                                   kernel_size = 3, 
                                   stride = 1, 
                                   padding = 1, 
        ...
        self.final = nn.Conv2d(in_channels = num_channels, 
                               out_channels =in_channels, 
                               kernel_size = 9, 
                               stride = 1, 
                               padding = 4)
